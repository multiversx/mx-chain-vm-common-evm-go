...
import (
	...
	"github.com/multiversx/mx-chain-vm-common-evm-go/builtInFunctions/convertEncoding/eth"
...
func detachAddressValue(context *common.EncodingContext, addressValue *mvxAbi.AddressValue) (interface{}, error) {
	...
	addressResponse, err := context.Accounts.RequestAddress(&evmcommon.AddressRequest{
